...
namespace Six_axis_robot__master_computer
{
    public class Bianliang  //用静态变量(必须使用静态变量，必须！！！)作全局变量，看看与上面的区别，上面的方法更灵活多变
    {
        ...
        public static Double X_Sudu = 1000;
        public static Double Y_Sudu = 3000;
        public static Double Z_Sudu = 250;
        public static Double E0_Sudu = 80;
        public static Double E1_Sudu = 80;
    }
}
